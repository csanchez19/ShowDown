    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2 col-12">
            <div class="row justify-content-center d-inline">
                ...
                <div class="row">
                        <div class="col-8">
                            <a class="escalar" href="<?php echo base_url(). 'index.php/showdown/WinnersLeague' ?>"><p class="text text3 escalar ml-lg-5 ml-0">Intercanvia els punts a la nostra Winners League! <span class="badge bg-danger mr-3"> New </span></p></a>
                        </div>
                        <div class="col-4">
